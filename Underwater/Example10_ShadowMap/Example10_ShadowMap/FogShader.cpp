...
void FogShader::setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX &worldMatrix, const XMMATRIX &viewMatrix, const XMMATRIX &projectionMatrix, ID3D11ShaderResourceView* texture, float* fog, float* cameraPos)
{
	HRESULT result;
	...
	fogPtr->cameraPosition = { cameraPos[0], cameraPos[1] };
